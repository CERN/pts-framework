...
*   **Embeddable:** Drive pypts from your own Python code with `pypts.api` - headless runs (`Pts`) or the window with a recipe loaded and started (`open_gui`). See `api_showcase.py` in the repository root.
